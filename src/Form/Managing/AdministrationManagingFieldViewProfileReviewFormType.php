...
final class AdministrationManagingFieldViewProfileReviewFormType extends AbstractType
{
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        $resolver->setDefaults([
            'data_class' => AdministrationManagingFieldViewProfileReviewData::class,
            'method' => 'POST',
        ]);
    }
}
