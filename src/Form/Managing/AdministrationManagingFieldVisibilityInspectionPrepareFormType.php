...
final class AdministrationManagingFieldVisibilityInspectionPrepareFormType extends AbstractType
{
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        $resolver->setDefaults([
            'data_class' => AdministrationManagingFieldVisibilityInspectionPrepareData::class,
            'method' => 'POST',
        ]);
    }
}
