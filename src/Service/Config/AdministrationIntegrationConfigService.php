...
final readonly class AdministrationIntegrationConfigService implements ConfigToolServiceInterface
{
    ...
    public function descriptor(): ConfigToolDescriptor
    {
        return new ConfigToolDescriptor(
            ...
            formClass: AdministrationIntegrationConfigFormType::class,
    ...
    {
        $data = new AdministrationIntegrationConfigData();
    ...
    private function assertData(object $data): AdministrationIntegrationConfigData
    {
        if (!$data instanceof AdministrationIntegrationConfigData) {
            throw new \InvalidArgumentException('Administering integration config expects AdministrationIntegrationConfigData.');
        }
     ...
     * @return array<string, mixed>
     */
    private function manifestPatch(AdministrationIntegrationConfigData $data): array
    {
        return [
     ...
     */
    private function stateRows(AdministrationIntegrationConfigData $data, string $status): array
    {
        return [
