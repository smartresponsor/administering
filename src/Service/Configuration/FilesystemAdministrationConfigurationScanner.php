...
namespace App\Administering\Service\Configuration;
...
final class FilesystemAdministrationConfigurationScanner implements AdministrationConfigurationScannerInterface
{
    /** @var list<string> */
