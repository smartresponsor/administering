...
final class AdministrationRuntimeScopeSourceIndexController extends AbstractController
{
    ...
    #[Route('/ea/administering/runtime/scope/composer/index', name: 'administration_composer_index', methods: ['GET'])]
    ...
    #[Route('/ea/administering/runtime/scope/application/index', name: 'administration_runtime_scope_index', methods: ['GET'])]
    ...
    #[Route('/ea/administering/runtime/scope/lock/index', name: 'administration_runtime_lock_index', methods: ['GET'])]
