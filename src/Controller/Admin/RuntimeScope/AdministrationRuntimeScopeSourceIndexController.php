...
final class AdministrationRuntimeScopeSourceIndexController extends AbstractController
{
    ...
    #[Route('/ea/administration/runtime/scope/composer/index', name: 'administration_composer_index', methods: ['GET'])]
    ...
    #[Route('/ea/administration/runtime/scope/application/index', name: 'administration_runtime_scope_index', methods: ['GET'])]
    ...
    #[Route('/ea/administration/runtime/scope/lock/index', name: 'administration_runtime_lock_index', methods: ['GET'])]
