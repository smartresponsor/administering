...
/**
 * EasyAdmin surface for launching safe metadata-only Administering operations.
 */
final class AdministrationOperationLaunchController extends AbstractController
{
    ...
    #[Route('/ea/operation', name: 'administration_operations', methods: ['GET'])]
    ...
    #[Route('/ea/operation/{operationType}/start', name: 'administration_operation_start', methods: ['POST'])]
