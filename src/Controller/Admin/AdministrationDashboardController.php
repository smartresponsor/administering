...
#[AdminDashboard(routePath: '/ea', routeName: 'administration_admin_index')]
final class AdministrationDashboardController extends AbstractDashboardController
{
    ...
    #[Route('/ea/section/{sectionKey}/tool', name: 'administration_service_section_tools', methods: ['GET'], defaults: [
    ...
    #[Route('/ea/section/{sectionKey}/tool/{toolShortName}', name: 'administration_service_section_tool_detail', methods: ['GET'], defaults: [
        EA::ROUTE_CREATED_BY_EASYADMIN => true,
        EA::DASHBOARD_CONTROLLER_FQCN => self::class,
        EA::CRUD_CONTROLLER_FQCN => null,
        EA::CRUD_ACTION => null,
    ...
    #[Route('/ea/tool/{toolKey}/open', name: 'administration_service_tool_open', methods: ['GET', 'POST'], defaults: [
        EA::ROUTE_CREATED_BY_EASYADMIN => true,
        EA::DASHBOARD_CONTROLLER_FQCN => self::class,
        EA::CRUD_CONTROLLER_FQCN => null,
        EA::CRUD_ACTION => null,
    ...
    #[Route('/ea/tool/{toolKey}/control', name: 'administration_service_tool_runtime_controls', methods: ['GET', 'POST'], defaults: [
        EA::ROUTE_CREATED_BY_EASYADMIN => true,
        EA::DASHBOARD_CONTROLLER_FQCN => self::class,
        EA::CRUD_CONTROLLER_FQCN => null,
        EA::CRUD_ACTION => null,
