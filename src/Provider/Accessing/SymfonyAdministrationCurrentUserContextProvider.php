...
final class SymfonyAdministrationCurrentUserContextProvider implements AdministrationCurrentUserContextProviderInterface
{
    ...
    public function current(): ?AdministrationCurrentUserContext
    {
        ...
        if (str_starts_with($user::class, 'App\\Administering\\') && method_exists($user, 'getId')) {
            $id = $user->getId();
            if (null !== $id) {
