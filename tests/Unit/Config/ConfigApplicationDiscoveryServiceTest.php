...
use App\Administering\Service\Config\ConfigApplicationDiscoveryService;
use PHPUnit\Framework\TestCase;

final class ConfigApplicationDiscoveryServiceTest extends TestCase
{
...
YAML);
        ...
        $service = new ConfigApplicationDiscoveryService($projectDir, ['DemoComponent']);
