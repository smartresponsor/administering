...
use App\Administering\Service\Config\AdministrationConfigSecretService;
...
final class AdministrationConfigSecretServiceTest extends TestCase
{
    public function testRejectsUnknownSecretField(): void
    {
        ...
        $service = new AdministrationConfigSecretService($operator);
